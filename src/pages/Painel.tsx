...
const STORAGE_KEY = "copa-croche-progress";
...
const Painel = () => {
  ...
  return (
    <div className="min-h-screen bg-background pb-20 lg:pb-0">
      <header className="sticky top-0 z-50 bg-gradient-to-r from-emerald-700 to-blue-700 text-white shadow-lg">
              ...
              {activeLesson.type === "video" ? (
                <div className="relative">
                  {activeLesson.videoUrl ? (
                    ...
                    <div className="aspect-video bg-gradient-to-br from-emerald-900 to-blue-900 flex flex-col items-center justify-center text-white gap-4">
                ...
                <div className="aspect-video bg-gradient-to-br from-amber-50 to-orange-50 flex flex-col items-center justify-center gap-4 p-8">
                  ...
                  {activeLesson.pdfUrl ? (
                    <a
                      ...
                      className="inline-flex items-center gap-2 bg-gradient-to-r from-emerald-700 to-blue-700 text-white font-semibold font-body text-sm px-6 py-3 rounded-xl shadow-lg hover:scale-105 transition-transform"
                    >
                  ...
                  <button
                    ...
                    className={`shrink-0 flex items-center gap-1.5 px-3 py-2 rounded-lg text-xs font-body font-semibold transition-all ${
                      isCurrentDone
                        ...
                        : "bg-gradient-to-r from-emerald-700 to-blue-700 text-white shadow-md hover:shadow-lg hover:scale-105"
                    }`}
                  >
              ...
              <button
                ...
                className={`flex-1 flex items-center gap-2 rounded-xl px-4 py-3.5 text-right transition-all disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:shadow-none ${
                  isCurrentDone && nextEntry
                    ? "bg-gradient-to-r from-emerald-700 to-blue-700 text-white shadow-lg hover:shadow-xl hover:scale-[1.02]"
      ...
      <div className="lg:hidden fixed bottom-4 left-4 z-40">
        <Sheet open={drawerOpen} onOpenChange={setDrawerOpen}>
          <SheetTrigger asChild>
            <button className="w-14 h-14 rounded-full bg-gradient-to-r from-emerald-700 to-blue-700 text-white shadow-xl flex items-center justify-center hover:scale-105 active:scale-95 transition-transform">
